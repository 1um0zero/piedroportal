...
function mapAdditions(o) {
  ...
  return {
    // Section 1: Additions
    // NOTE: these mm fields are Dataverse *choice* columns — read the label via
    // optSided(), not the raw numeric code. (sided() here caused 979580xxx codes
    // to be stored; backfilled by scripts/fix-imported-optionset-additions.mjs.)
    lat_joint_w:  optSided('cr56f_lateraljointwidthlf', 'cr56f_lateraljointwidthrf'),
    med_joint_w:  optSided('cr56f_medialjointwidthlf', 'cr56f_medialjointwidthrf'),
    lat_heel_w:   optSided('cr56f_lateralheelwidthlf', 'cr56f_lateralheelwidthrf'),
    med_heel_w:   optSided('cr56f_medialheelwidthlf', 'cr56f_medialheelwidthrf'),
    hammer_toe:   optSided('cr56f_2hammertoelf', 'cr56f_2hammertoerf'),
    toe_box:      optSided('cr56f_2toeboxlf', 'cr56f_2toeboxrf'),
    bunionette:   optSided('cr56f_2bunionettelf', 'cr56f_2bunionetterf'),
    hallux_v:     optSided('cr56f_2halluxvalguslf', 'cr56f_2halluxvalgusrf'),
    depth_fore:   optSided('cr56f_2depthtoforepartlf', 'cr56f_2depthtoforepartrf'),
    depth_toe:    optSided('cr56f_2depthtotoeheellf', 'cr56f_2depthtotoeheelrf'),
    xw_cone:      optSided('cr56f_2extrawidthonconelf', 'cr56f_2extrawidthonconerf'),
    str_heel:     optSided('cr56f_2straightenheelcliplf', 'cr56f_2straightenheelcliprf'),
    heel_depth:   optSided('cr56f_2heeldepthonlylf', 'cr56f_2heeldepthonlyrf'),
    haglund:      optSided('cr56f_2haglundheelexostosislf', 'cr56f_2haglundheelexostosisrf'),
    ...
    pad_tongue:    optSided('cr56f_extrapaddingontonguelf', 'cr56f_extrapaddingontonguerf'),
    ...
    sf_medial:    optSided('cr56f_3sf_mediallf', 'cr56f_3sf_medialrf'),
    sf_lateral:   optSided('cr56f_3sf_laterallf', 'cr56f_3sf_lateralrf'),
    heel_float:   bool(o.cr56f_3heelfloatlf, o.cr56f_3heelfloatrf),
    hf_medial:    optSided('cr56f_3hf_mediallf', 'cr56f_3hf_medialrf'),
    hf_lateral:   optSided('cr56f_3hf_laterallf', 'cr56f_3hf_lateralrf'),
    sole_wedge:   bool(o.cr56f_4solewedgelf, o.cr56f_4solewedgerf),
    sw_medial:    optSided('cr56f_4sw_mediallf', 'cr56f_4sw_medialrf'),
    sw_lateral:   optSided('cr56f_4sw_laterallf', 'cr56f_4sw_lateralrf'),
    heel_wedge:   bool(o.cr56f_4heelwedgelf, o.cr56f_4heelwedgerf),
    hw_medial:    optSided('cr56f_4hw_mediallf', 'cr56f_4hw_medialrf'),
    hw_lateral:   optSided('cr56f_4hw_laterallf', 'cr56f_4hw_lateralrf'),
