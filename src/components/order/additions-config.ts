...
export const SECTIONS: AdditionSection[] = [
  ...
  // ── Section 3: Sole & Heel ────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      // Chips ordered by material family, A→Z within each family (order is cosmetic —
      // codes map by label string in dataverse-option-codes.ts, not by array index).
      { key: 'sole_type',    type: 'option', side: 'both', collapse: true, conditionalOn: 'amend_sole', values: ['EVA Black','EVA Brown','EVA Grey','EVA Taupe','EVA White','EVA Lightweight Amber','EVA Lightweight Black','EVA Lightweight Off-White','EVA Lightweight Taupe','Sportive Beige','Sportive Black','Sportive Grey','Sportive White','Full Rubber Amber','Full Rubber Black','Full Rubber Blue','Full Rubber Pink','Full Rubber White'], dataverseKey: 'cr56f_6evawedgecolour' },
      { key: 'spoiler',      type: 'option', side: 'both', collapse: true, conditionalOn: 'amend_sole', values: ['Amber','Black','Cobalt','Dark Blue','Dark Brown','Dark Grey','Light Grey','Red'], dataverseKey: 'cr56f_6spoiler' },
      { key: 'runner_sole',  type: 'option', side: 'both', collapse: true, conditionalOn: 'amend_sole', values: ['Piedro Runner Amber','Piedro Runner Black','Rubber Amber','Rubber Black','Fish Amber','Fish Black','Tire Amber','Tire Black','EVA Nora Astro Star Lightweight Amber','EVA Nora Astro Star Lightweight Black','EVA Lightweight Port Flex Amber','EVA Lightweight Port Flex Black','Lightweight Vibram Sole Black','Lightweight Vibram Sole Brown','Lightweight Sole Forli Uomo','Full Rubber Sole Montana Black','Full Rubber Sole Montana Brown','Nora Sole Plate Black with Black Body Colour','Nora Sole Plate Black with Light Body Colour','Nora Sole Plate Blue with Light Body Colour'], dataverseKey: 'cr56f_6runnersole' },
      ...
      // Aflopend (tapered) — single-select, mutually exclusive: to Joint OR to Toes,
      // never both (Anabela, 2026-07-14). Optional → may be neither. No `collapse`
      // so both chips stay visible to switch.
      { key: 'sf_taper', type: 'option', side: 'both', conditionalOn: 'sole_float', optional: true, values: ['Tapered to Joint','Tapered to Toes'], dataverseKey: 'cr56f_3sf_tapered' },
      ...
      { key: 'sw_taper', type: 'option', side: 'both', conditionalOn: 'sole_wedge', optional: true, values: ['Tapered to Joint','Tapered to Toes'], dataverseKey: 'cr56f_4sw_tapered' },
