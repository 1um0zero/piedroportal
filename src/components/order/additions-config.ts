...
export const SECTIONS: AdditionSection[] = [
  ...
  // ── Section 2: Upper Adaptions ────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { key: 'zipper',       label: 'Zipper',                      labelNl: 'Rits',                          type: 'option', side: 'both', values: ['Medial (next to closure)','Medial (side)','Lateral (next to closure)'], dataverseKey: 'cr56f_zipper' },
    ],
  },
