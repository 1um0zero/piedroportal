...
export const SECTIONS: AdditionSection[] = [
  ...
  // ── Section 3: Sole & Heel ────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      // Spoiler removed 2026-07-14 (Anabela): it is now fixed to the sole, no longer
      // separately ordered. Legacy decode stays in dataverse-option-codes.ts (cr56f_6spoiler).
