...
const mm0to60Values = Array.from({ length: 61 }, (_, i) => i)
export function MmFloatingSlider() {
  const [value, setValue] = useState<number | string | null>(20)
  return <RangeField values={mm0to60Values} value={value} onChange={setValue} unit="mm" />
}
